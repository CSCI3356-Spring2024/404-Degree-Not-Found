"""
Django settings for EaglePlan project.
...
SECRET_KEY = 'django-insecure-v5iu*wrv7(3(a7f)exq_a!3o2ibq%hyamk#1y@rkz*9!b*l11@'
...
CSRF_TRUSTED_ORIGINS = [
    'https://web-production-4313f.up.railway.app'
]
...
WSGI_APPLICATION = 'EaglePlan.wsgi.application'
