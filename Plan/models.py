...
class Plan(models.Model):
    ...
    s1 = models.JSONField(blank=True, default=list)
    s2 = models.JSONField(blank=True, default=list)
    s3 = models.JSONField(blank=True, default=list)
    s4 = models.JSONField(blank=True, default=list)
    s5 = models.JSONField(blank=True, default=list)
    s6 = models.JSONField(blank=True, default=list)
    s7 = models.JSONField(blank=True, default=list)
    s8 = models.JSONField(blank=True, default=list)
